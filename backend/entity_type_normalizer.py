"""
Entity type normalization (ported from MiroFish-Optimize).

Goal: reduce duplicate nodes when the extractor emits unstable/fine-grained types.
We normalize into a small canonical set when possible.
"""
